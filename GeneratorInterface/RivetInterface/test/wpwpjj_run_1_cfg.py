...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/a/anlevin/data/lhe/qed_4_qcd_99_sm.lhe')
)
...
def customise(process):
        ...
        process.rivetAnalyzer.AnalysisNames = cms.vstring('wpwpjj_run_1')
